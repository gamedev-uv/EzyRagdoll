...
- [Rig Template Creator](#rig-template-creator)
   - [Step 1: Opening the Rig Template Creator Window](#step-1-opening-the-rig-template-creator-window)
   - [Step 2: Assign Your Character's Rig Pelvis](#step-2-assign-your-characters-rig-pelvis)
   - [Step 3: Assign Other Bones](#step-3-assign-other-bones)
   - [Step 4: Create the Rig Template](#step-4-create-the-rig-template)
   - [The Create Button is Disabled?](#the-create-button-is-disabled)
- [Ragdoll Creator](#ragdoll-creator)
   - [Step 1: Opening the Ragdoll Creator Window](#step-1-opening-the-ragdoll-creator-window)
   - [Step 2: Assign Your Character's Rig Pelvis](#step-2-assign-your-characters-rig-pelvis)
   - [Step 3: Assign Other Bones](#step-3-assign-other-bones)
     - [Manual Assignment](#manual-assignment)
     - [Rig Template (Auto Loading)](#rig-template-auto-loading)
   - [Step 4: Configure Ragdoll Settings](#step-4-configure-ragdoll-settings)
   - [Step 5: Build Ragdoll](#step-5-build-ragdoll)
...
The `RigTemplateCreator` is an editor window used to create rig templates for your ragdoll setup in Unity.
...
The `RagdollCreator` is an editor window used to create ragdolls in Unity by interacting with a `RigTemplate`.
